...
for (i in seq_along(datalist_condition_b)) {
  ...
  for (contrast in contrasts) {
    ...
    results_list[[paste0(name_condition_b, "_Carrier_", contrast)]] <- get_results(dep_carrier)
    ...
    for (j in seq_along(datalist_other)) {
      ...
      results_list[[paste0(name_condition_b, "_", heat_name, "_", contrast, "_uncorrected")]] <- get_results(dep_not_cor)
      ...
      results_list[[paste0(name_condition_b, "_", heat_name, "_", contrast, "_corrected")]] <- get_results(dep_cor)
